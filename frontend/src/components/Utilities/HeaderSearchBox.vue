...
<template>
  <form class="mx-2 mt-2 flex items-center justify-between" action="">
    <div
        ...
        :class="[searchBoxPinia.isSearchBoxClicked ? 'outline-lavender w-85Percent' : 'outline-green-500']"
    >
      <div class="flex-grow">
        <input
    ...
    <div v-if="searchBoxPinia.isSearchBoxClicked" class="w-15Percent" @click="searchBoxPinia.setSearchBox(false)">
